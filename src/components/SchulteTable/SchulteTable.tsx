        ...
        <Animated.View style={[{ width: cellSize, height: cellSize, padding: 2 }, animatedStyle]}>
            <Pressable
                ...
                style={({ pressed }) => ({
                    ...
                    backgroundColor: isCompleted ? '#222' : '#0F0F0F', // Dim when done
                    borderWidth: 1,
                    borderColor: isNext ? colors.primary : 'rgba(255,255,255,0.05)',
                    alignItems: 'center',
            ...
            >
                <Text
                    style={{
                        ...
                        color: isCompleted ? '#444' : '#FFF', // Fade out when done
...
// Red Dot Center Cell
const RedDotCell: React.FC<{ cellSize: number }> = ({ cellSize }) => {
    return (
        <View style={{ width: cellSize, height: cellSize, padding: 2 }}>
            <View style={{
                ...
                <View style={{
                    ...
                    backgroundColor: '#FF0000', // Explicit Red
                    shadowColor: '#FF0000',
                    shadowOpacity: 0.6,
                    shadowRadius: 10,
                    elevation: 5
        ...
        <View style={{ width: '100%', alignItems: 'center' }}>
            ...
            >
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', flex: 1 }}>
                    ...
                    <View>
                        <Text style={{ fontSize: 10, color: '#888', letterSpacing: 1, fontWeight: '600' }}>{t('games.schulte.target')}</Text>
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8 }}>
                    <View style={{ alignItems: 'flex-end' }}>
                        <Text style={{ fontSize: 10, color: '#888', letterSpacing: 1, fontWeight: '600' }}>{t('games.common.time')}</Text>
                        <Text style={{ fontSize: 20, color: '#fff', fontVariant: ['tabular-nums'] }}>{formatTime(elapsed)}</Text>
                    </View>
