                    ...
                    <Animated.View entering={FadeIn.delay(1000)} style={styles.buttonContainer}>
                        <Pressable
                            ...
                            style={({ pressed }) => [
                                ...
                                { backgroundColor: pressed ? '#00cccc' : colors.primary }
                            ]}
                        >
                            <RotateCcw size={20} color="#000" />
                            <Text style={styles.primaryButtonText}>{t('games.common.playAgain')}</Text>
                        </Pressable>
                        ...
                        >
                            <X size={20} color="#fff" />
                            <Text style={styles.secondaryButtonText}>{t('games.common.close')}</Text>
                        </Pressable>
                    </Animated.View>
                </Animated.View>
            </View>
